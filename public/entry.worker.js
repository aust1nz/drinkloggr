...
function getMatchesToLoad(
  ...
  fetchLoadMatches.forEach((f2, key) => {
    if (
      isInitialLoad ||
      !matches.some((m) => m.route.id === f2.routeId) ||
  ...
  async _handleMessage(event) {
    ...
    if (data.type === 'REMIX_NAVIGATION') {
      ...
      if (!existingDocument || !isMount) {
        ...
        cachePromises.set(
          documentUrl,
          documentCache2.put(documentUrl, response).catch((error) => {
            if (true)
              logger.error(
                `Failed to cache document for ${documentUrl}:`,
                error,
              );
          }),
        );
        ...
        for (const match of matches) {
          if (manifest.routes[match.id].hasLoader) {
            ...
            if (!cachePromises.has(url)) {
              if (true) logger.debug('Caching data for:', url);
              const response = await fetch(url);
              cachePromises.set(
                url,
                dataCache2.put(url, response).catch((error) => {
                  if (true)
...
var assets = [
  '/build/root-CMDWQBEN.js',
  '/build/manifest-1D40F2B6.js',
  '/build/entry.client-A7FJLDRG.js',
  '/build/__remix_entry_dev-OYRU4TLA.js',
  '/build/routes/trends-JKB6CQAZ.js',
  '/build/routes/settings-6JDAN7LT.js',
  '/build/routes/manifest[.]webmanifest-J3KYYY3Q.js',
  '/build/routes/calendar-A35COB64.js',
  '/build/routes/auth.google.callback-RT4XPXLD.js',
  '/build/routes/auth.google-VGCC6HJ5.js',
  '/build/routes/_index-TW5K32MD.js',
  '/build/_assets/tailwind-TRSOLO2G.css',
  '/build/_shared/runtime-GC7QIU56.js',
  '/build/_shared/remix_hmr-XMX7JIUG.js',
  ...
  '/build/_shared/esm-PLCL5GMS.js',
  '/build/_shared/client-DFZR44C7.js',
  '/build/_shared/chunk-ZWGWGGVF.js',
  '/build/_shared/chunk-YOKM36DQ.js',
  '/build/_shared/chunk-XU7DNSPJ.js',
  '/build/_shared/chunk-UWV35TSL.js',
  '/build/_shared/chunk-TUXXPBCJ.js',
  '/build/_shared/chunk-PNG5AS42.js',
  '/build/_shared/chunk-OGU7UOK2.js',
  '/build/_shared/chunk-JQXM6346.js',
  '/build/_shared/chunk-HQH5UK35.js',
